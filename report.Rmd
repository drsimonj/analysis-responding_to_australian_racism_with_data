...
Looking at this Figure, most Centreline payments fall along the dotted line, which is what we'd expect from a fair system (if `r scales::percent(max(upper_breakdown$p))` of the recipients were Australian-born).
